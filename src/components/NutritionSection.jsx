    ...
    <section className="py-12 px-4 md:px-12 bg-white">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {overviewCards.map((card, index) => (
         <div
         key={index}
         className="relative group p-6 rounded-2xl shadow-lg bg-gradient-to-br from-white to-gray-50 transition-all duration-300 overflow-hidden border border-gray-300 hover:border-black hover:shadow-2xl hover:scale-105 transform transition-all"
       >
       
            <div className="relative z-10">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800 group-hover:text-green-500 transition-all duration-200">{card.title}</h2>
              <p className="text-gray-600 leading-relaxed text-justify group-hover:text-gray-700 transition-all duration-200">
                    {card.description}
              </p>
